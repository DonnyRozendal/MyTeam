...
class GetTeamFromFirestoreUseCase(private val pokemonRepository: PokemonRepository) :
    UseCase<List<Pokemon>, UseCase.None>() {

    override fun invoke(params: None) = pokemonRepository.getTeamFromFirestore()
